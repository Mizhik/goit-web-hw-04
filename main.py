...
def save_data_from_form(data):
    ...
    try:
        ...
        time_message = datetime.now().isoformat()
        time_obj = datetime.fromisoformat(time_message) 
        formatted_time = time_obj.strftime("%Y-%m-%d %H:%M:%S.%f")
        new_dict = {formatted_time: parse_dict}
